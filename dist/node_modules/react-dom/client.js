(function (global, factory) {
	...
	function mountState(initialState) {
	    // 找到挡墙useState对应的hook数据
	    const hook = mountWorkInProgresshool();
	    let memoizedState;
	    ...
	    // @ts-ignore
	    const dispatch = dispatcherSetState.bind(null, currentlyRenderingFiber, queue);
	    queue.dispatch = dispatch;
	    return [memoizedState, dispatch];
	}
	function dispatcherSetState(fiber, updateQueue, action) {
	    const update = createUpdate(action);
	    enqueueUpdate(updateQueue, update);
	    scheduleUpdateOnFiber(fiber);
	}
	function mountWorkInProgresshool() {
	    const hook = {
	        memoizedState: null,
	        updateQueue: null,
	        next: null
